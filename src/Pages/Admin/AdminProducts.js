...
const AdminProducts = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      data.append('tshirtType', formData.tshirtType);
      ...
      showNotification(
        err.response?.data?.error || 'Ürün kaydedilirken bir hata oluştu.',
        'error'
      );
    } finally {
      setLoading(false);
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="flex justify-end space-x-4 mb-6">
        <Link to="/Admin/Manage" className="text-blue-500 hover:underline">Sipariş Yönetimi</Link>
